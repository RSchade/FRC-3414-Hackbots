...
public class Spinner implements IRobot 
{
    ...
    public void SetStraightShooter(boolean rightButtonOne) {
        if (rightButtonOne == true && motorState == true)        // if the button is pressed once,                                i=     controller button     a=
        ...
        if (rightButtonOne == false)                             // if the button is let go,                                      2           deactivated      activated
    ...
    public void pushPiston(boolean rightButtonTwo) {                                                                 // *start shooter code*   
        if (rightButtonTwo == true || pushPistonState == true)   // if the button is pressed    -or-   "pushPistonState" = true :                                   
        {                                                                                                                  
    ...
    public void pushMotor(boolean rightButtonTwo) {
        if (rightButtonTwo == true || pushMotorState == true)    // if the button is pressed    -or-   "pushPistonState" = true :                                
        {                                                                                              
